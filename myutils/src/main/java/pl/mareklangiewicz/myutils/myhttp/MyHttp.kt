...
object GitHub {
    ...
    const val AGENT = "User-Agent: MyHttp"
    ...
    interface Service {
        ...
        @Headers(ACCEPT, AGENT)
        @GET("/user")
        fun getUserAuth(@Header("Authorization") auth: String): Call<User>

        @Headers(ACCEPT, AGENT)
        @GET("/user")
        fun getUserTFA(@Header("Authorization") auth: String, @Header("X-GitHub-OTP") code: String): Call<User>

        @Headers(ACCEPT, AGENT)
        @GET("/users/{user}/repos")
        fun getUserRepos(@Path("user") user: String): Call<List<Repository>>

        @Headers(ACCEPT, AGENT)
        @GET("/user/repos")
        fun getUserReposAuth(@Header("Authorization") auth: String): Call<List<Repository>>

        @Headers(ACCEPT, AGENT)
        @GET("/user/repos")
        fun getUserReposTFA(@Header("Authorization") auth: String, @Header("X-GitHub-OTP") code: String): Call<List<Repository>>
    }
