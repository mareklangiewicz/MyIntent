...
/**
 * Third party LinearLayoutManager implementation.
 * This file is used because current implementation of LinearLayoutManager
 * in android does not respect the "wrap_content" layout setting.
 * It will be removed when Google fixes this issue.
 */
 ...
 * the measure pass.
 */
public class WCLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public WCLinearLayoutManager(Context context) {
        super(context);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public WCLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public WCLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WCLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
