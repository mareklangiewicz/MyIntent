...
public final class MyDrawableTestsFragment extends MyFragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private final MyLivingDrawable[] mDrawables = {
            ...
            new MyMagicLinesDrawable().setLines(0, 3000, 3000, 6000, 6000, 9000, 9000, 10000, 0, 10000).setColor(0x400000a0),
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            ViewGroup.MarginLayoutParams cardparams = new ViewGroup.MarginLayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
